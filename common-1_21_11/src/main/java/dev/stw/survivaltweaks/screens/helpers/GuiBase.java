package dev.stw.survivaltweaks.screens.helpers;
...
public abstract class GuiBase extends Screen {
    public static final Identifier BG_NORMAL = SurvivalTweaks.assetLocation("gui/bg.png");
    public static final Identifier BG_LARGE = SurvivalTweaks.assetLocation("gui/bg-help.png");
    ...
    public void renderBackground(GuiGraphics guiGraphics, int x, int y, float partialTicks) {
        ...
        if (this.hasSide) {
            ...
            if (hasSideTitle())
                guiGraphics.drawString(getFontRender(), this.sideTitle, width / 2 + 80, height / 2 - 77, 0xFFFFFF00, false);
        }
        ...
        if (hasTitle()) {
            if (this.hasSide)
                guiGraphics.drawString(getFontRender(), title(), width / 2 - 138, height / 2 - 105, 0xFFFFFF00, false);
            else
                guiGraphics.drawString(getFontRender(), title(), width / 2 - (this.backgroundWidth / 2) + 14, height / 2 - (this.backgroundHeight / 2) + 13, 0xFFFFFF00, false);
        }
    }
